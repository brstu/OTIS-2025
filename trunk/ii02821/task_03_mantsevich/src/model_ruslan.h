#ifndef MODEL_RUSLAN_H
#define MODEL_RUSLAN_H
 ...
 * @author Ruslan
 *
 * The Model_ruslan class represents a system whose state is described by the variable @c y.
...
public:
     ...
     */
    explicit Model_ruslan(double y0 = 0.0) noexcept;
