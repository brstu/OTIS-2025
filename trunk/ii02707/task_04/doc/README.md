...
## Введение
Данная лабораторная работа расчитана на то, чтобы закрепить знания работы с Git, GitHub. Также она позволяет нам 
...
Соответсвенно нам не удасться запустить проект на последней (на момент выполнения) версии. 
