...
\hypertarget{gtest-typed-test__test_8cc_source}{}\label{gtest-typed-test__test_8cc_source}\index{test/build/\_deps/googletest-\/src/googletest/test/gtest-\/typed-\/test\_test.cc@{test/build/\_deps/googletest-\/src/googletest/test/gtest-\/typed-\/test\_test.cc}}
...
\DoxyCodeLine{00130\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_typed_test1}{TypedTest1}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00131\ }
...
\DoxyCodeLine{00138\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_typed_test2}{TypedTest2}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00139\ }
...
\DoxyCodeLine{00153\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classlibrary1_1_1_numeric_test}{NumericTest}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00154\ }
...
\DoxyCodeLine{00200\ }
\DoxyCodeLine{00201\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_typed_test_suite_p_state_test}{TypedTestSuitePStateTest}}\ :\ \textcolor{keyword}{public}\ Test\ \{}
...
\DoxyCodeLine{00224\ \}}
\DoxyCodeLine{00225\ }
\DoxyCodeLine{00226\ \textcolor{keyword}{using\ }TypedTestSuitePStateDeathTest\ =\ \mbox{\hyperlink{class_typed_test_suite_p_state_test}{TypedTestSuitePStateTest}};}
\DoxyCodeLine{00227\ }
...
\DoxyCodeLine{00260\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_derived_test}{DerivedTest}}\ :\ \textcolor{keyword}{public}\ CommonTest<T>\ \{\};}
\DoxyCodeLine{00261\ }
...
\DoxyCodeLine{00293\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_type_parametrized_test_with_names}{TypeParametrizedTestWithNames}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00294\ }
...
\DoxyCodeLine{00334\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_typed_test_p1}{TypedTestP1}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00335\ }
...
\DoxyCodeLine{00352\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_typed_test_p2}{TypedTestP2}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00353\ }
...
\DoxyCodeLine{00388\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classlibrary2_1_1_numeric_test}{NumericTest}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
\DoxyCodeLine{00389\ }
...
\DoxyCodeLine{00396\ \}}
\DoxyCodeLine{00397\ }
\DoxyCodeLine{00398\ REGISTER\_TYPED\_TEST\_SUITE\_P(\mbox{\hyperlink{classlibrary2_1_1_numeric_test}{NumericTest}},\ DefaultIsZero,\ ZeroIsLessThanOne);}
\DoxyCodeLine{00399\ \textcolor{keyword}{typedef}\ Types<int,\ double>\ NumericTypes;}
\DoxyCodeLine{00400\ INSTANTIATE\_TYPED\_TEST\_SUITE\_P(My,\ \mbox{\hyperlink{classlibrary2_1_1_numeric_test}{NumericTest}},\ NumericTypes);}
\DoxyCodeLine{00401\ }
...
\DoxyCodeLine{00407\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classlibrary2_1_1_trimmed_test}{TrimmedTest}}\ :\ \textcolor{keyword}{public}\ Test\ \{\};}
...
\DoxyCodeLine{00411\ TYPED\_TEST\_P(\mbox{\hyperlink{classlibrary2_1_1_trimmed_test}{TrimmedTest}},\ Test3)\ \{\ EXPECT\_STREQ(\textcolor{stringliteral}{"{}Test3"{}},\ GetTestName());\ \}}
\DoxyCodeLine{00412\ TYPED\_TEST\_P(\mbox{\hyperlink{classlibrary2_1_1_trimmed_test}{TrimmedTest}},\ Test4)\ \{\ EXPECT\_STREQ(\textcolor{stringliteral}{"{}Test4"{}},\ GetTestName());\ \}}
\DoxyCodeLine{00413\ TYPED\_TEST\_P(\mbox{\hyperlink{classlibrary2_1_1_trimmed_test}{TrimmedTest}},\ Test5)\ \{\ EXPECT\_STREQ(\textcolor{stringliteral}{"{}Test5"{}},\ GetTestName());\ \}}
\DoxyCodeLine{00414\ REGISTER\_TYPED\_TEST\_SUITE\_P(\mbox{\hyperlink{classlibrary2_1_1_trimmed_test}{TrimmedTest}},\ Test1,\ Test2,\ Test3,\ Test4,}
