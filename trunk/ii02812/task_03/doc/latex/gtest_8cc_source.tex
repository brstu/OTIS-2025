...
\hypertarget{gtest_8cc_source}{}\label{gtest_8cc_source}\index{test/build/\_deps/googletest-\/src/googletest/src/gtest.cc@{test/build/\_deps/googletest-\/src/googletest/src/gtest.cc}}
...
\DoxyCodeLine{00445\ \textcolor{keywordtype}{void}\ AssertHelper::operator=(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_message}{Message}}\&\ message)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00999\ \ \ \ \ \mbox{\hyperlink{class_unit_test_impl}{UnitTestImpl}}*\ unit\_test)}
...
\DoxyCodeLine{01009\ \ \ \ \ \mbox{\hyperlink{class_unit_test_impl}{UnitTestImpl}}*\ unit\_test)}
...
\DoxyCodeLine{01205\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_message}{Message}}*\ msg)\ \{}
...
\DoxyCodeLine{02590\ \mbox{\hyperlink{structtesting_1_1internal_1_1_function}{Result}}\ HandleSehExceptionsInMethodIfSupported(T*\ \textcolor{keywordtype}{object},\ \mbox{\hyperlink{structtesting_1_1internal_1_1_function}{Result}}\ (T::*method)(),}
...
\DoxyCodeLine{02605\ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\mbox{\hyperlink{structtesting_1_1internal_1_1_function}{Result}}\textcolor{keyword}{>}(0);}
\DoxyCodeLine{02606\ \ \ \}}
...
\DoxyCodeLine{02617\ \mbox{\hyperlink{structtesting_1_1internal_1_1_function}{Result}}\ HandleExceptionsInMethodIfSupported(T*\ \textcolor{keywordtype}{object},\ \mbox{\hyperlink{structtesting_1_1internal_1_1_function}{Result}}\ (T::*method)(),}
...
\DoxyCodeLine{02661\ \ \ \ \ \}}
\DoxyCodeLine{02662\ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\mbox{\hyperlink{structtesting_1_1internal_1_1_function}{Result}}\textcolor{keyword}{>}(0);}
...
\DoxyCodeLine{02720\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structtesting_1_1internal_1_1_code_location}{internal::CodeLocation}}\ a\_code\_location,}
\DoxyCodeLine{02721\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ internal::TypeId\ fixture\_class\_id,}
\DoxyCodeLine{02722\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1_test_factory_base}{internal::TestFactoryBase}}*\ factory)}
...
\DoxyCodeLine{03352\ \textcolor{keyword}{class\ }PrettyUnitTestResultPrinter\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classtesting_1_1_test_event_listener}{TestEventListener}}\ \{}
...
\DoxyCodeLine{03365\ \ \ \textcolor{keywordtype}{void}\ OnTestCaseStart(\textcolor{keyword}{const}\ TestCase\&\ test\_case)\ \textcolor{keyword}{override};}
...
\DoxyCodeLine{03376\ \ \ \textcolor{keywordtype}{void}\ OnTestCaseEnd(\textcolor{keyword}{const}\ TestCase\&\ test\_case)\ \textcolor{keyword}{override};}
...
\DoxyCodeLine{03660\ \textcolor{keyword}{class\ }BriefUnitTestResultPrinter\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classtesting_1_1_test_event_listener}{TestEventListener}}\ \{}
...
\DoxyCodeLine{03674\ \ \ \textcolor{keywordtype}{void}\ OnTestCaseStart(\textcolor{keyword}{const}\ TestCase\&\ \textcolor{comment}{/*test\_case*/})\textcolor{keyword}{\ override\ }\{\}}
...
\DoxyCodeLine{03685\ \ \ \textcolor{keywordtype}{void}\ OnTestCaseEnd(\textcolor{keyword}{const}\ TestCase\&\ \textcolor{comment}{/*test\_case*/})\textcolor{keyword}{\ override\ }\{\}}
...
\DoxyCodeLine{03709\ \}}
\DoxyCodeLine{03710\ }
\DoxyCodeLine{03711\ \textcolor{keywordtype}{void}\ BriefUnitTestResultPrinter::OnTestEnd(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_test_info}{TestInfo}}\&\ test\_info)\ \{}
...
\DoxyCodeLine{03765\ \textcolor{keyword}{class\ }TestEventRepeater\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classtesting_1_1_test_event_listener}{TestEventListener}}\ \{}
...
\DoxyCodeLine{03792\ \ \ \textcolor{keywordtype}{void}\ OnTestCaseEnd(\textcolor{keyword}{const}\ TestCase\&\ parameter)\ \textcolor{keyword}{override};}
...
\DoxyCodeLine{03817\ \}}
\DoxyCodeLine{03818\ }
\DoxyCodeLine{03819\ \mbox{\hyperlink{class_test_event_listener}{TestEventListener}}*\ TestEventRepeater::Release(\mbox{\hyperlink{class_test_event_listener}{TestEventListener}}*\ listener)\ \{}
...
\DoxyCodeLine{03896\ \textcolor{keyword}{class\ }XmlUnitTestResultPrinter\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classtesting_1_1_empty_test_event_listener}{EmptyTestEventListener}}\ \{}
...
\DoxyCodeLine{03999\ \textcolor{keywordtype}{void}\ XmlUnitTestResultPrinter::OnTestIterationEnd(\textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1_unit_test}{UnitTest}}\&\ unit\_test,}
...
\DoxyCodeLine{04444\ \textcolor{keyword}{class\ }JsonUnitTestResultPrinter\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classtesting_1_1_empty_test_event_listener}{EmptyTestEventListener}}\ \{}
...
\DoxyCodeLine{04511\ \}}
\DoxyCodeLine{04512\ }
\DoxyCodeLine{04513\ \textcolor{keywordtype}{void}\ JsonUnitTestResultPrinter::OnTestIterationEnd(\textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1_unit_test}{UnitTest}}\&\ unit\_test,}
...
\DoxyCodeLine{04524\ \ \ \mbox{\hyperlink{class_message}{Message}}\ m;}
\DoxyCodeLine{04525\ }
...
\DoxyCodeLine{06193\ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1_os_stack_trace_getter_interface}{OsStackTraceGetterInterface}}*\ getter)\ \{}
...
\DoxyCodeLine{06203\ \mbox{\hyperlink{classtesting_1_1internal_1_1_os_stack_trace_getter_interface}{OsStackTraceGetterInterface}}*\ UnitTestImpl::os\_stack\_trace\_getter()\ \{}
...
\DoxyCodeLine{06374\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{bool}\ ParseFlag(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ str,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ flag\_name,\ \mbox{\hyperlink{classtesting_1_1internal_1_1_string}{String}}*\ value)\ \{}
...
\DoxyCodeLine{06806\ ScopedTrace::\string~ScopedTrace()\ GTEST\_LOCK\_EXCLUDED\_(\&\mbox{\hyperlink{classtesting_1_1_unit_test}{UnitTest}}::mutex\_)\ \{}
