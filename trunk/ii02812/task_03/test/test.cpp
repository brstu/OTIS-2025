 ...
 * @file test.cpp
<<<<<<< HEAD
 * @brief Íàáîð ìîäóëüíûõ òåñòîâ äëÿ êëàññà PID è ëèíåéíîé ìîäåëè.
=======
 * @brief ÐÐ°Ð±Ð¾Ñ€ Ð¼Ð¾Ð´ÑƒÐ»ÑŒÐ½Ñ‹Ñ… Ñ‚ÐµÑÑ‚Ð¾Ð² Ð´Ð»Ñ ÐºÐ»Ð°ÑÑÐ° PID Ð¸ Ð»Ð¸Ð½ÐµÐ¹Ð½Ð¾Ð¹ Ð¼Ð¾Ð´ÐµÐ»Ð¸.
