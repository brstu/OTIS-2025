/**
 * @file main.cpp
 * @brief Êîíñîëüíîå ïðèëîæåíèå ìîäåëèðîâàíèÿ PID-ðåãóëÿòîðà è ëèíåéíîãî îáúåêòà.
 */
...
#include "lin_model.h"
 ...
 /**
  * @brief Ïðîâåðêà êîððåêòíîñòè ââîäà ÷èñëîâîãî çíà÷åíèÿ.
  * @tparam N ×èñëîâîé òèï.
  * @param number Ïåðåìåííàÿ, â êîòîðóþ çàïèñûâàåòñÿ ââîä.
