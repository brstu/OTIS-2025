...
Улучшено форматирование и исправлены орфографические ошибки в русскоязычном Readme к проекту Nika и англоязычных Readme агентов
![my pull-request](1.png)
![my pull-request](2.png)

## Pull-request

Ссылка на мой pull-request в `ostis-apps/nika`: [https://github.com/ostis-apps/nika/pull/380/files](https://github.com/ostis-apps/nika/pull/380/files).
