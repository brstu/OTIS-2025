...
private:
    ...
    double t_curr = 1.0; ///< Текущее значение выходной переменной
    double t_prev = 0.0; ///< Предыдущее значение выходной переменной
    double u_curr = 1.0; ///< Текущее значение входной переменной
    double u_prev = 0.0; ///< Предыдущее значение входной переменной
...
public:
     ...
     */
    void setState(double tcurr, double tprev, double ucurr, double uprev);
