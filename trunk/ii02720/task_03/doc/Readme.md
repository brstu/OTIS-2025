...
<p align="right">Группы ИИ-27/24</p>
...
![5](images/5.png)
Рисунок 0.2 П-регулятор. К1 = 10, T1=0, TD=0

![6](images/6.png)
Рисунок 0.3 ПИ-регулятор. К1=10, T1=0.1, TD=0

![7](images/7.png)
Рисунок 0.4 ПИД-регулятор. K1=10, T1=0.1, TD =50
